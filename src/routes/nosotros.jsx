  ...
  return (
    <>
      ...
      <div className='flex'>
        ...
        Checkpoint es una página que brinda su servicio a instituciones para facilitar el registro de asistencias dentro de las mismas.\ln
        Se utiliza una base de datos para cargar de forma sencilla la información necesaria de cada identidad.\ln
